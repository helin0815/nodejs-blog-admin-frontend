...
const LabelInfoList = lazy(() => import('../../components/LabelInfo/List'))
const LabelInfoCreate = lazy(() => import(/* webpackChunkName: "LabelInfoCreate" */ '../../components/LabelInfo/Create'))
const ChatWithGPT = lazy(()=>import (/* webpackChunkName: "ChatWithGPT" */ '../../components/ChatGPT/Chat'))
        ...
        >
            <Suspense fallback={<Spin/>}>
                <Routes>
                    ...
                    <Route key="LabelInfoList" path="/labelInfo/list" element={<LabelInfoList/>}/>
                    <Route key='LabelInfoCreate' path="/labelInfo/create" element={<LabelInfoCreate/>}/>
                    <Route key='ChatWithGPT' path="/chat_gpt/create" element={<ChatWithGPT/>}/>
                </Routes>
            </Suspense>
        </Content>
    )
