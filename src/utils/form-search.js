...
export const labelInfoFormItemMap = {
    status: labelInfosDefaultStatus,
    input: [
        {
            filedName: "field-labelInfo-id",
            value_key: "id",
            placeholder: "标签ID"
        },
        {
            filedName: "failed-article-id",
            value_key: "article_id",
            placeholder: "文章ID"
        },
        {
            filedName: "failed-labelInfo-content",
            value_key: "content",
            placeholder: "标签内容"
        }
    ],
